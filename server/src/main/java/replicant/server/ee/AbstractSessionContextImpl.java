...
public abstract class AbstractSessionContextImpl implements ReplicantChangeRecorder, ReplicantSessionContext {
    ...
    protected void addInstanceRootRouterKey(
    ...
    @Nullable
    protected Integer decodeNullableIntAttribute(
            @NonNull final ResultSet resultSet,
            @NonNull final Map<String, Serializable> attributeValues,
            @NonNull final String key,
            @NonNull final String columnLabel)
    ...
    protected void decodeTimestampAttribute(
            @NonNull final ResultSet resultSet,
            @NonNull final Map<String, Serializable> attributeValues,
            @NonNull final String key,
            @NonNull final String columnLabel)
    ...
    protected void decodeNullableTimestampAttribute(
            @NonNull final ResultSet resultSet,
            @NonNull final Map<String, Serializable> attributeValues,
            @NonNull final String key,
            @NonNull final String columnLabel)
    ...
    protected void decodeDateAttribute(
            @NonNull final ResultSet resultSet,
            @NonNull final Map<String, Serializable> attributeValues,
            @NonNull final String key,
            @NonNull final String columnLabel)
    ...
    protected void decodeNullableDateAttribute(
            @NonNull final ResultSet resultSet,
            @NonNull final Map<String, Serializable> attributeValues,
            @NonNull final String key,
            @NonNull final String columnLabel)
    ...
    protected void decodeStringAttribute(
            @NonNull final ResultSet resultSet,
            @NonNull final Map<String, Serializable> attributeValues,
            @NonNull final String key,
            @NonNull final String columnLabel)
    ...
    protected void decodeNullableStringAttribute(
            @NonNull final ResultSet resultSet,
            @NonNull final Map<String, Serializable> attributeValues,
            @NonNull final String key,
            @NonNull final String columnLabel)
    ...
    protected void decodeBooleanAttribute(
            @NonNull final ResultSet resultSet,
            @NonNull final Map<String, Serializable> attributeValues,
            @NonNull final String key,
            @NonNull final String columnLabel)
    ...
    protected void decodeNullableBooleanAttribute(
            @NonNull final ResultSet resultSet,
            @NonNull final Map<String, Serializable> attributeValues,
            @NonNull final String key,
            @NonNull final String columnLabel)
