...
public class SystemMetaDataTest
{
  ...
  public void basicOperation()
  {
    final ChannelMetaData ch0 =
      new ChannelMetaData( 0, ValueUtil.randomString(), true, ChannelMetaData.FilterType.NONE, null, false );
    final ChannelMetaData ch1 =
      new ChannelMetaData( 1, ValueUtil.randomString(), true, ChannelMetaData.FilterType.NONE, null, false );
    final ChannelMetaData ch2 =
      new ChannelMetaData( 2, ValueUtil.randomString(), true, ChannelMetaData.FilterType.NONE, null, false );
