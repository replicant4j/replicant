...
public class AbstractSessionContextImplTest {
    ...
    public void deriveTargetDatasetKey_throwsWhenNotOverridden() {
        ...
        assertEquals(
                ...
                "deriveTargetDatasetKey called for Dataset Link from " + sourceDatasetAddress + " to "
                        ...
                        + entityChangeCandidate + " but no such Dataset Link exists or the target Dataset "
    ...
    private static final class TestSessionContext extends AbstractSessionContextImpl {
        ...
        void registerEntityChangeCandidateForObject(
                @NonNull final Object object, @NonNull final EntityChangeCandidate entityChangeCandidate) {
            _entityChangeCandidates.put(object, entityChangeCandidate);
        }
