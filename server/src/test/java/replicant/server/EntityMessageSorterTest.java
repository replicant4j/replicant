...
public class EntityMessageSorterTest
{
  ...
  {
    final var messages = new EntityMessage[]{ createDeletionMessage( 1 ),
  ...
  {
    final var messages = new EntityMessage[]{ createUpdateMessage( 1 ),
                                       createDeletionMessage( 1 ),
  ...
  {
    final var messages = new EntityMessage[]{ createDeletionMessage( 2, 10 ),
  ...
  {
    final var messages = new EntityMessage[]{ createUpdateMessage( 2, 10 ),
