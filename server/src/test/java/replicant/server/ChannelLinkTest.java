...
public final class ChannelLinkTest
{
  ...
  {
    final var link = new ChannelLink( new ChannelAddress( 22, 44 ), new ChannelAddress( 1, 2 ), null, false );
  ...
  {
    final var link1 = new ChannelLink( new ChannelAddress( 22, 44 ), new ChannelAddress( 1, 2 ), null, false );
    final var link2 = new ChannelLink( new ChannelAddress( 22, 44 ), new ChannelAddress( 1, 3 ), null, false );
    final var link3 = new ChannelLink( new ChannelAddress( 22, 77 ), new ChannelAddress( 1, 2 ), null, false );
    final var link4 = new ChannelLink( new ChannelAddress( 27 ), new ChannelAddress( 1, 2 ), null, false );
    final var link5 = new ChannelLink( new ChannelAddress( 27 ), new ChannelAddress( 1, 3 ), null, false );
