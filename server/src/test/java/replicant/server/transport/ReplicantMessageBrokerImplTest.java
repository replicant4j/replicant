...
public class ReplicantMessageBrokerImplTest
{
  ...
  @Test
  public void enqueueWhileSessionIsRunningSchedulesAdditionalDrainTask()
  ...
  @Test
  public void concurrentEnqueuesRespectConfiguredMaxDrainTasks()
    throws InterruptedException
  {
    final var broker = new TestReplicantMessageBrokerImpl();
    broker.setMaxConcurrentDrainTasks( 2 );
  ...
  @Test
  public void lockContentionRequeuesSessionAndSchedulesDelayedRetry()
    throws InterruptedException
  {
    final var session = newSession();
    final var broker = new TestReplicantMessageBrokerImpl();
  ...
  @Test
  public void repeatedNoProgressPassesCoalesceDelayedRetries()
    throws InterruptedException
  {
    final var session1 = newSession();
    final var session2 = newSession();
  ...
  @Test
  public void delayedRetryCallbackDoesNothingWhenStopping()
    throws InterruptedException
  {
    final var session = newSession();
    final var broker = new TestReplicantMessageBrokerImpl();
  ...
  @Test
  public void packetProcessingFailureClosesOnlyAffectedSession()
    throws Exception
  {
    final var session1 = newSession();
    final var session2 = newSession();
  ...
  @Test
  public void packetProcessingFailureDoesNotStopCurrentDrainTask()
    throws Exception
  {
    final var session1 = newSession();
    final var session2 = newSession();
  ...
  @Test
  public void delayedRetrySubmissionFailureClearsRetryState()
    throws InterruptedException
  {
    final var session = newSession();
    final var broker = new TestReplicantMessageBrokerImpl();
    ...
    extends ReplicantMessageBrokerImpl
  {
    ...
    void runNextDrainTaskInNewThread()
      throws InterruptedException
    {
