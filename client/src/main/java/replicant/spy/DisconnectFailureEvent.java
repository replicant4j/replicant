 ...
 */
public final class DisconnectFailureEvent implements SerializableEvent {
    private final int _systemSchemaId;

    @NonNull
    private final String _systemSchemaName;

    public DisconnectFailureEvent(final int systemSchemaId, @NonNull final String systemSchemaName) {
