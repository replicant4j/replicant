 ...
 */
public final class DataLoaderMessageProcessFailureEvent
  implements SerializableEvent
{
  ...
  public DataLoaderMessageProcessFailureEvent( @Nonnull final Class<?> systemType, @Nonnull final Throwable error )
  {
