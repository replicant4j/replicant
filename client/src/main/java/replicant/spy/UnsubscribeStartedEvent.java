...
/**
 * Notification when a Connector starts to unsubscribe from a channel.
 */
public final class UnsubscribeStartedEvent implements SerializableEvent {
    ...
    public UnsubscribeStartedEvent(
