 ...
 */
public final class DataLoaderDisconnectFailureEvent
  implements SerializableEvent
{
  ...
  public DataLoaderDisconnectFailureEvent( @Nonnull final Class<?> systemType, @Nonnull final Throwable error )
  {
