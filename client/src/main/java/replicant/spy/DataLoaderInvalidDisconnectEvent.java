 ...
 */
public final class DataLoaderInvalidDisconnectEvent
  implements SerializableEvent
{
  ...
  public DataLoaderInvalidDisconnectEvent( @Nonnull final Class<?> systemType, @Nonnull final Throwable error )
  {
