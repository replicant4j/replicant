 ...
 */
public final class ConnectFailureEvent implements SerializableEvent {
    private final int _systemSchemaId;

    @NonNull
    private final String _systemSchemaName;

    public ConnectFailureEvent(final int systemSchemaId, @NonNull final String systemSchemaName) {
