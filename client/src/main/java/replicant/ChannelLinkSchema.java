...
public final class ChannelLinkSchema {
    ...
    public ChannelLinkSchema(
            final int sourceDatasetId, final int targetDatasetId, final boolean auto, @NonNull final String[] path) {
    ...
    public String toString() {
        if (Replicant.areNamesEnabled()) {
            return "ChannelLink[" + getSourceDatasetId() + "->" + getTargetDatasetId() + " via "
