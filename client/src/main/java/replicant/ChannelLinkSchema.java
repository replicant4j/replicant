...
public final class ChannelLinkSchema {
    ...
    public ChannelLinkSchema(
            final int sourceChannelId, final int targetChannelId, final boolean auto, @NonNull final String[] path) {
    ...
    public String toString() {
        if (Replicant.areNamesEnabled()) {
            return "ChannelLink[" + getSourceChannelId() + "->" + getTargetChannelId() + " via "
