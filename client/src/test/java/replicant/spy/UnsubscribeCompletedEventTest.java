...
public class UnsubscribeCompletedEventTest extends AbstractReplicantTest {
    @Test
    public void basicOperation() {
        final DatasetAddress datasetAddress = new DatasetAddress(1, 2);
        final UnsubscribeCompletedEvent event = new UnsubscribeCompletedEvent(23, "Rose", datasetAddress);
