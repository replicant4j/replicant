...
public final class CommandCompletedEventTest extends AbstractReplicantTest {
    @Test
    public void basicOperation() {
        ...
        final CommandCompletedEvent event =
                new CommandCompletedEvent(systemSchemaId, systemSchemaName, commandName, requestId);
        ...
        assertEquals(data.get("type"), "Connector.CommandCompleted");
