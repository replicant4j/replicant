...
public final class ExecCompletedEventTest extends AbstractReplicantTest {
    @Test
    public void basicOperation() {
        ...
        final ExecCompletedEvent event = new ExecCompletedEvent(systemSchemaId, systemSchemaName, command, requestId);
