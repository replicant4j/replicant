...
public class DataLoaderMessageProcessFailureEventTest
  extends AbstractReplicantTest
{
  @Test
  public void basicOperation()
  {
    final DataLoaderMessageProcessFailureEvent event =
      new DataLoaderMessageProcessFailureEvent( G.class, new Error( "Some ERROR" ) );
  ...
  {
    final DataLoaderMessageProcessFailureEvent event =
      new DataLoaderMessageProcessFailureEvent( G.class, new NullPointerException() );
