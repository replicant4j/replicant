...
public class DataLoaderInvalidConnectEventTest
  extends AbstractReplicantTest
{
  @Test
  public void basicOperation()
  {
    final DataLoaderInvalidConnectEvent event =
      new DataLoaderInvalidConnectEvent( G.class, new Error( "Some ERROR" ) );
  ...
  {
    final DataLoaderInvalidConnectEvent event =
      new DataLoaderInvalidConnectEvent( G.class, new NullPointerException() );
