...
public class DataLoaderDisconnectFailureEventTest
  extends AbstractReplicantTest
{
  @Test
  public void basicOperation()
  {
    final DataLoaderDisconnectFailureEvent event =
      new DataLoaderDisconnectFailureEvent( G.class, new Error( "Some ERROR" ) );
  ...
  {
    final DataLoaderDisconnectFailureEvent event =
      new DataLoaderDisconnectFailureEvent( G.class, new NullPointerException() );
