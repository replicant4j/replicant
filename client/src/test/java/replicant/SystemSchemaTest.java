...
public class SystemSchemaTest extends AbstractReplicantTest {
    ...
    public void basicOperation() {
        ...
        final EntitySchema entity1 = new EntitySchema(
                0, ValueUtil.randomString(), Integer.class, (i, d) -> 1, null, new ChannelLinkSchema[0]);
        final EntitySchema entity2 = new EntitySchema(
                1, ValueUtil.randomString(), String.class, (i, d) -> "", null, new ChannelLinkSchema[0]);
    ...
    public void getChannel_BadIndex() {
        final SystemSchema systemSchema = new SystemSchema(
                ValueUtil.randomInt(), ValueUtil.randomString(), new ChannelSchema[] {}, new EntitySchema[] {});
    ...
    public void construct_nullEntity() {
        ...
        final IllegalStateException exception = expectThrows(
                ...
                () -> new SystemSchema(ValueUtil.randomInt(), "X", new ChannelSchema[] {}, new EntitySchema[] {null}));
        assertEquals(
                exception.getMessage(),
    ...
    public void construct_badEntityIndex() {
        ...
        final IllegalStateException exception = expectThrows(
                IllegalStateException.class,
                () -> new SystemSchema(
                        ValueUtil.randomInt(), "X", new ChannelSchema[] {}, new EntitySchema[] {entity1}));
        assertEquals(
                exception.getMessage(),
                "Replicant-0054: SystemSchema named 'X' passed an array of entities where entity at index 0 does not"
    ...
    public void construct_badChannelIndex() {
        ...
        final IllegalStateException exception = expectThrows(
                IllegalStateException.class,
                () -> new SystemSchema(
                        ValueUtil.randomInt(), "X", new ChannelSchema[] {channel1}, new EntitySchema[] {}));
        assertEquals(
                exception.getMessage(),
    ...
    public void passNameToConstructorWhenNamesDisabled() {
        ...
        final IllegalStateException exception = expectThrows(
                IllegalStateException.class,
                () -> new SystemSchema(ValueUtil.randomInt(), "MySystem", new ChannelSchema[0], new EntitySchema[0]));
        assertEquals(
                exception.getMessage(),
