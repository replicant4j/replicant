...
public class EntityTest extends AbstractReplicantTest {
    @Test
    ...
    public void getUserObject_whenNull() {
        ...
        final IllegalStateException exception =
                expectThrows(IllegalStateException.class, () -> safeAction(() -> assertNull(entity.getUserObject())));

        assertEquals(
                exception.getMessage(), "Replicant-0071: Entity.getUserObject() invoked when no userObject present");
    }
    ...
    public void typeSubscriptions() {
        ...
        final Entity entity = safeAction(
                () -> entityService.findOrCreateEntity(ValueUtil.randomString(), String.class, ValueUtil.randomInt()));
    ...
    public void delinkFromSubscription_whenNotLinked() {
        ...
        final IllegalStateException exception = expectThrows(
                IllegalStateException.class, () -> safeAction(() -> entity.delinkFromSubscription(subscription1)));
        assertEquals(
                exception.getMessage(),
                "Replicant-0081: Entity.delinkFromSubscription invoked on Entity MyEntity passing subscription 1.0.1"
                        + " but entity is not linked to subscription.");
    }
    ...
    public void linkToSubscription_whenNotLinked() {
        ...
        final IllegalStateException exception = expectThrows(
                IllegalStateException.class, () -> safeAction(() -> entity.linkToSubscription(subscription1)));
        assertEquals(
                exception.getMessage(),
                "Replicant-0080: Entity.linkToSubscription invoked on Entity MyEntity passing subscription 1.0.1 but"
                        + " entity is already linked to subscription.");
    }
