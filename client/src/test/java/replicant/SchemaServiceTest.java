...
public class SchemaServiceTest extends AbstractReplicantTest {
    @Test
    ...
    public void registerSchema_duplicate() {
        ...
        assertEquals(
                ...
                "Replicant-0070: Attempted to register schema with id 100 when a schema with id already exists:"
                        + " MySchema1");
    }
