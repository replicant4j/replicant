...
public class ChangeSetMessageTest
  extends AbstractReplicantTest
{
  ...
  public void construct()
  {
    ...
    final ChangeSetMessage changeSet =
      ChangeSetMessage.create( requestId, eTag, channelChanges, fchannels, entityChanges );
  ...
  public void validate_whereAllOK()
  {
    ...
    final ChangeSetMessage changeSet =
      ChangeSetMessage.create( null, null, channelChanges, null, entityChanges );
  ...
  public void validate_duplicateChannelActions_typeChannel()
  {
    ...
    final ChangeSetMessage changeSet =
      ChangeSetMessage.create( null, null, channelChanges, null, null );
  ...
  public void validate_duplicateChannelActions_instanceChannel()
  {
    ...
    final ChangeSetMessage changeSet =
      ChangeSetMessage.create( null, null, new String[]{ "+1", "+4.23" }, channelChanges, null );
  ...
  public void validate_duplicateEntityChanges()
  {
    ...
    final ChangeSetMessage changeSet =
      ChangeSetMessage.create( null, null, null, null, entityChanges );
