...
public class ReplicantTest extends AbstractReplicantTest {
    @Test
    ...
    @Test
    public void setting_shouldValidateReplicasAfterMessageProcessing() {
        assertTrue(Replicant.shouldValidateReplicasAfterMessageProcessing());
        ReplicantTestUtil.noValidateReplicasAfterMessageProcessing();
        assertFalse(Replicant.shouldValidateReplicasAfterMessageProcessing());
    }
    ...
    public void zone_basicOperation() {
        ...
        assertEquals(ReplicantZoneHolder.getDefaultZone().getReplicantContext(), Replicant.context());
        ...
        zone1.safeRun(() -> {
            assertEquals(zone1.getReplicantContext(), Replicant.context());
    ...
    public void zone_multipleZones() {
        ...
        zone1.safeRun(() -> {
            ...
            zone2.safeRun(() -> {
                assertEquals(zone2.getReplicantContext(), Replicant.context());
                ...
                zone1.safeRun(() -> {
                    ...
                    zone3.safeRun(() -> {
                        assertEquals(zone3.getReplicantContext(), Replicant.context());
    ...
    public void createZone_when_zonesDisabled() {
        ...
        assertEquals(
                exception.getMessage(), "Replicant-0001: Invoked Replicant.createZone() but zones are not enabled.");
    }
    ...
    public void activateZone_whenZonesNotEnabled() {
        ...
        assertEquals(
                exception.getMessage(), "Replicant-0002: Invoked Replicant.activateZone() but zones are not enabled.");
    }
    ...
    public void currentZone_whenZonesNotEnabled() {
        ReplicantTestUtil.disableZones();
        final IllegalStateException exception = expectThrows(IllegalStateException.class, Replicant::currentZone);
        assertEquals(
                exception.getMessage(), "Replicant-0005: Invoked Replicant.currentZone() but zones are not enabled.");
    }
