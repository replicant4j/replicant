...
public class AreaOfInterestRequestTest extends AbstractReplicantTest {
    ...
    public void construct_withNOnNullFIlterAndRemoveAction() {
        final IllegalStateException exception = expectThrows(
                ...
                () -> new AreaOfInterestRequest(new ChannelAddress(1, 2), AreaOfInterestRequest.Type.REMOVE, "XXX"));

        assertEquals(
                exception.getMessage(),
                "Replicant-0027: AreaOfInterestRequest constructor passed a REMOVE request for address '1.2' with a"
                        + " non-null filter 'XXX'.");
    }
