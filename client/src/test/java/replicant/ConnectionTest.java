...
public class ConnectionTest extends AbstractReplicantTest {
    ...
    public void requestSubscribe() {
        ...
        connection.requestSubscribe(datasetAddress1, filter1);

        assertEquals(connection.getPendingAreaOfInterestRequests().size(), 1);

        connection.requestSubscribe(datasetAddress2, filter2);
    ...
    public void requestSubscriptionUpdate() {
        ...
        connection.requestSubscriptionUpdate(datasetAddress1, filter1);

        assertEquals(connection.getPendingAreaOfInterestRequests().size(), 1);

        connection.requestSubscriptionUpdate(datasetAddress2, filter2);
    ...
    public void completeAreaOfInterestRequest() {
        ...
        final AreaOfInterestRequest request1 =
                new AreaOfInterestRequest(datasetAddress1, AreaOfInterestRequest.Type.ADD, filter1);
        final AreaOfInterestRequest request2 =
                new AreaOfInterestRequest(datasetAddress2, AreaOfInterestRequest.Type.ADD, filter2);
    ...
    public void canGroupRequests() {
        ...
        final AreaOfInterestRequest request1 =
                new AreaOfInterestRequest(datasetAddressA, AreaOfInterestRequest.Type.ADD, filterP);
        final AreaOfInterestRequest request2 =
                new AreaOfInterestRequest(datasetAddressA, AreaOfInterestRequest.Type.REMOVE, filterP);
        final AreaOfInterestRequest request3 =
                new AreaOfInterestRequest(datasetAddressA, AreaOfInterestRequest.Type.UPDATE, filterP);
        final AreaOfInterestRequest request4 =
                new AreaOfInterestRequest(datasetAddressA, AreaOfInterestRequest.Type.ADD, filterP);

        final AreaOfInterestRequest request10 =
                new AreaOfInterestRequest(datasetAddressB, AreaOfInterestRequest.Type.ADD, filterQ);
        final AreaOfInterestRequest request11 =
                new AreaOfInterestRequest(datasetAddressC, AreaOfInterestRequest.Type.ADD, filterQ);
        ...
        final AreaOfInterestRequest request14 =
                new AreaOfInterestRequest(datasetAddressE, AreaOfInterestRequest.Type.UPDATE, filterQ);
        final AreaOfInterestRequest request15 =
                new AreaOfInterestRequest(datasetAddressE, AreaOfInterestRequest.Type.ADD, filterP);
        final AreaOfInterestRequest request16 =
                new AreaOfInterestRequest(datasetAddressE, AreaOfInterestRequest.Type.UPDATE, filterP);
        final AreaOfInterestRequest request17 =
                new AreaOfInterestRequest(datasetAddressE, AreaOfInterestRequest.Type.REMOVE, null);
        final AreaOfInterestRequest request18 =
                new AreaOfInterestRequest(datasetAddressE, AreaOfInterestRequest.Type.UPDATE, filterP);
        final AreaOfInterestRequest request19 =
                new AreaOfInterestRequest(datasetAddressE, AreaOfInterestRequest.Type.UPDATE, filterR);
    ...
    public void lastIndexOfPendingAreaOfInterestRequest_passingNonnullFilterForDelete() {
        ...
        final IllegalStateException exception = expectThrows(
                ...
                () -> connection.lastIndexOfPendingAreaOfInterestRequest(
                        AreaOfInterestRequest.Type.REMOVE, datasetAddress, filter));
        assertEquals(
                exception.getMessage(),
                "Replicant-0024: Connection.lastIndexOfPendingAreaOfInterestRequest passed a REMOVE request for"
                        + " Dataset Address '1.0' with a non-null filter 'MyFilter'.");
    }
    ...
    public void isAreaOfInterestRequestPending_passingNonnullFilterForDelete() {
        ...
        assertEquals(
                ...
                "Replicant-0025: Connection.isAreaOfInterestRequestPending passed a REMOVE request for Dataset Address"
                        + " '1.0' with a non-null filter 'MyFilter'.");
    }
    ...
    public void pendingAreaOfInterestRequestQueries_requestPending() {
        ...
        assertRequestPendingState(connection, datasetAddress1, filter1, false, false, false, -1, -1, -1);
        assertRequestPendingState(connection, datasetAddress2, filter2, false, false, false, -1, -1, -1);
        assertRequestPendingState(connection, datasetAddress3, filter3, false, false, false, -1, -1, -1);

        connection.requestSubscribe(datasetAddress1, null);

        assertRequestPendingState(connection, datasetAddress1, filter1, true, false, false, 1, -1, -1);
        assertRequestPendingState(connection, datasetAddress2, filter2, false, false, false, -1, -1, -1);
        assertRequestPendingState(connection, datasetAddress3, filter3, false, false, false, -1, -1, -1);
        ...
        assertRequestPendingState(connection, datasetAddress1, filter1, true, false, false, 1, -1, -1);
        assertRequestPendingState(connection, datasetAddress2, filter2, false, true, false, -1, 2, -1);
        assertRequestPendingState(connection, datasetAddress3, filter3, false, false, false, -1, -1, -1);
        ...
        assertRequestPendingState(connection, datasetAddress1, filter1, true, false, false, 1, -1, -1);
        assertRequestPendingState(connection, datasetAddress2, filter2, false, true, false, -1, 2, -1);
        assertRequestPendingState(connection, datasetAddress3, filter3, false, false, true, -1, -1, 3);
    }
    ...
    public void pendingAreaOfInterestRequestQueries_currentPending() {
        ...
        assertRequestPendingState(connection, datasetAddress1, filter1, true, false, false, 0, -1, -1);
        assertRequestPendingState(connection, datasetAddress2, filter2, false, false, false, -1, -1, -1);
        assertRequestPendingState(connection, datasetAddress3, filter3, false, false, false, -1, -1, -1);
        ...
        assertRequestPendingState(connection, datasetAddress1, filter1, true, false, false, 0, -1, -1);
        assertRequestPendingState(connection, datasetAddress2, filter2, true, false, false, 0, -1, -1);
        assertRequestPendingState(connection, datasetAddress3, filter3, false, false, false, -1, -1, -1);
    }
    ...
    public void pendingAreaOfInterestRequestQueries_jumbledAggregate() {
        ...
        assertRequestPendingState(connection, datasetAddress2, filter2, false, false, false, -1, -1, -1);
        assertRequestPendingState(connection, datasetAddress3, filter3, false, false, false, -1, -1, -1);
        assertRequestPendingState(connection, datasetAddress4, filter4, false, false, false, -1, -1, -1);
        ...
        connection.requestUnsubscribe(datasetAddress3);
        connection.requestSubscriptionUpdate(datasetAddress3, filter3);
        ...
        connection.injectCurrentAreaOfInterestRequest(
                new AreaOfInterestRequest(datasetAddress1, AreaOfInterestRequest.Type.ADD, filter1));
        connection.injectCurrentAreaOfInterestRequest(
                new AreaOfInterestRequest(datasetAddress4, AreaOfInterestRequest.Type.ADD, filter4));

        assertRequestPendingState(connection, datasetAddress1, filter1, true, true, true, 10, 3, 1);
        assertRequestPendingState(connection, datasetAddress2, filter2, false, true, false, -1, 5, -1);
        assertRequestPendingState(connection, datasetAddress3, filter3, false, true, true, -1, 9, 8);
        assertRequestPendingState(connection, datasetAddress4, filter4, true, false, false, 0, -1, -1);
    }
    ...
    private void assertRequestPendingState(
        ...
        assertRequestPending(connection, AreaOfInterestRequest.Type.ADD, datasetAddress, filter, hasAdd);
        assertRequestPending(connection, AreaOfInterestRequest.Type.UPDATE, datasetAddress, filter, hasUpdate);
        assertRequestPending(connection, AreaOfInterestRequest.Type.REMOVE, datasetAddress, null, hasRemove);
        assertRequestPendingIndex(connection, AreaOfInterestRequest.Type.ADD, datasetAddress, filter, addIndex);
        assertRequestPendingIndex(connection, AreaOfInterestRequest.Type.UPDATE, datasetAddress, filter, updateIndex);
    ...
    private void assertRequestPendingIndex(
            ...
            @Nullable final Object filter,
            final int expected) {
        assertEquals(connection.lastIndexOfPendingAreaOfInterestRequest(action, datasetAddress, filter), expected);
    }
    ...
    private void assertRequestPending(
            ...
            @Nullable final Object filter,
            final boolean expected) {
        assertEquals(connection.isAreaOfInterestRequestPending(action, datasetAddress, filter), expected);
    }
}
