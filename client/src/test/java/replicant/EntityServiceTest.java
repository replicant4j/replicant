...
public class EntityServiceTest extends AbstractReplicantTest {
    @Test
    ...
    public void unlinkEntity_missingType() {
        ...
        final IllegalStateException exception =
                expectThrows(IllegalStateException.class, () -> safeAction(() -> service.unlinkEntity(entity)));
    ...
    public void disposedEntityNeverReturned() {
...

        {
            ...
            safeAction(() -> assertEquals(
                    Objects.requireNonNull(service.getEntities().get(A.class)).size(), 1));
        }
