...
public class SpyImplTest extends AbstractReplicantTest {
    @Test
    ...
    public void addSpyEventHandler_alreadyExists() {
        ...
        assertEquals(
                exception.getMessage(),
                "Replicant-0040: Attempting to add handler " + handler
    ...
    public void removeSpyEventHandler_noExists() {
        ...
        assertEquals(
                exception.getMessage(),
                "Replicant-0039: Attempting to remove handler " + handler
