...
* Extract generic `ReplicantSessionManagerImpl.processDeleteMessage()` from downstream libraries to make it easier to refactor logic in subscription managers.
